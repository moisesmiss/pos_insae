	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header with-border">
				<button data-toggle='modal' data-target='#modalProveedor' class="btn btn-primary">Agregar</button>
			</div>
			<div class="box-body">
				<table id="dtProveedores" class="table table-bordered table-striped tabla-datatable dt-responsive nowrap" style="width: 100%;">
					<thead>
						<tr>
							<th>Nombre</th>
							<th>Email</th>
...
<div id="modalProveedor" class="modal fade">
...
<script type="text/javascript" src="views/js/proveedores.js"></script>